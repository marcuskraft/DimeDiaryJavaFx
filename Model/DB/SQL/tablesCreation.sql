...
CREATE TABLE PUBLIC.BALANCE_HISTORY (
	...
	AMOUNT DOUBLE,
	CONSTRAINT BALANCE_HISTORY_PK PRIMARY KEY (BANKACCOUNT_ID,"DATE"),
	CONSTRAINT BALANCE_HISTORY_BANKACCOUNT_FK FOREIGN KEY (BANKACCOUNT_ID) REFERENCES PUBLIC.BANKACCOUNT(ID)
);

CREATE INDEX SYS_IDX_10741 ON PUBLIC.BALANCE_HISTORY (BANKACCOUNT_ID);

CREATE UNIQUE INDEX SYS_IDX_BALANCE_HISTORY_PK_10740 ON PUBLIC.BALANCE_HISTORY (BANKACCOUNT_ID,"DATE");