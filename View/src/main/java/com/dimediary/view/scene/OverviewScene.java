...
public class OverviewScene {
	...
	private final static Logger log = LogManager.getLogger(OverviewScene.class);
	...
	private CheckBox checkboxAccountlessTransactions; // Value injected by FXMLLoader
	...
	void onButtonAddTransaction(final ActionEvent event) throws IOException {
		...
		parameters.put(OverviewScene.class, this);
	...
	void initialize() {
		assert this.tabPane != null : "fx:id=\"tabPane\" was not injected: check your FXML file 'Overview.fxml'.";
		assert this.tabJanuary != null : "fx:id=\"tabJanuary\" was not injected: check your FXML file 'Overview.fxml'.";
		assert this.tabFebruary != null : "fx:id=\"tabFebruary\" was not injected: check your FXML file 'Overview.fxml'.";
		assert this.tabMarch != null : "fx:id=\"tabMarch\" was not injected: check your FXML file 'Overview.fxml'.";
		assert this.tabAprile != null : "fx:id=\"tabAprile\" was not injected: check your FXML file 'Overview.fxml'.";
		assert this.tabMay != null : "fx:id=\"tabMay\" was not injected: check your FXML file 'Overview.fxml'.";
		assert this.tabJune != null : "fx:id=\"tabJune\" was not injected: check your FXML file 'Overview.fxml'.";
		assert this.tabJuly != null : "fx:id=\"tabJuly\" was not injected: check your FXML file 'Overview.fxml'.";
		assert this.tabAugust != null : "fx:id=\"tabAugust\" was not injected: check your FXML file 'Overview.fxml'.";
		assert this.tabSeptembre != null : "fx:id=\"tabSeptembre\" was not injected: check your FXML file 'Overview.fxml'.";
		assert this.tabOctober != null : "fx:id=\"tabOctober\" was not injected: check your FXML file 'Overview.fxml'.";
		assert this.tabNovember != null : "fx:id=\"tabNovember\" was not injected: check your FXML file 'Overview.fxml'.";
		assert this.tabDecember != null : "fx:id=\"tabDecember\" was not injected: check your FXML file 'Overview.fxml'.";
		assert this.buttonBack != null : "fx:id=\"buttonBack\" was not injected: check your FXML file 'Overview.fxml'.";
		assert this.buttonForward != null : "fx:id=\"buttonForward\" was not injected: check your FXML file 'Overview.fxml'.";
		assert this.buttonActualMonth != null : "fx:id=\"buttonActualMonth\" was not injected: check your FXML file 'Overview.fxml'.";
		assert this.comboBoxAccount != null : "fx:id=\"comboBoxAccount\" was not injected: check your FXML file 'Overview.fxml'.";
		assert this.SpinnerYear != null : "fx:id=\"SpinnerYear\" was not injected: check your FXML file 'Overview.fxml'.";
		assert this.buttonAddTransaction != null : "fx:id=\"buttonAddTransaction\" was not injected: check your FXML file 'Overview.fxml'.";
		assert this.checkboxAccountlessTransactions != null : "fx:id=\"checkboxAccountlessTransactions\" was not injected: check your FXML file 'Overview.fxml'.";
	...
	private HashMap<Month, Tab> month2Tabs;
	...
	private void refreshMonthOverview(final Month month) {
		...
		for (int i = 0; i < maxTransaction + 4; i++) {
			...
			columnConstraint.setMaxWidth(300);
		...
		final OverviewScene overviewScene = this;
		...
		for (int i = 1; i <= dates.size(); i++) {
			...
			for (int j = transactions.size(); j < maxTransaction + 1; j++) {
				final Pane pane = this.getEmptyPane(overviewScene, date);
	...
	private Pane getEmptyPane(final OverviewScene overviewScene, final LocalDate date) {
		...
		pane.setOnDragDropped(new EventHandler<DragEvent>() {
			...
			public void handle(final DragEvent event) {
				...
				try {
					...
					DatabaseService.getInstance().rollbackTransaction();
					OverviewScene.log.error("Error by Moving Transaction to another date", e);
				}
